...
/*
	...
	public Kruskal(ArrayList<ArrayList<Integer>> matrix) {
		fathers = new int[matrix.size()];
	}
	...
	public static void main(String args[]){
		...
		Collections.sort(edges, new Comparator<Road>() {
			@Override 
		...
		while( ( mst_edges < n-1) || (mst_ni < m) ){
			...
			a = edges.get(mst_ni).getFrom();
			b = edges.get(mst_ni).getTo();
			w = edges.get(mst_ni).getMiles();
